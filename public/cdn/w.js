...
(function () {
  ...
  // ─── styles ─────────────────────────────────────────────
  var STYLES = '#blindai-banner{position:fixed;bottom:16px;left:16px;right:16px;z-index:2147483647;font-family:ui-monospace,SFMono-Regular,"JetBrains Mono","Menlo",monospace;font-size:14px;line-height:1.5;color:#B6FFCB;opacity:0;transform:translateY(16px);transition:opacity .28s ease,transform .28s ease;pointer-events:none}#blindai-banner.blindai-shown{opacity:1;transform:translateY(0);pointer-events:auto}.blindai-card{max-width:720px;margin:0 auto;background:#0a0e13;border:1px solid rgba(16,185,129,.4);border-radius:8px;padding:18px 20px;box-shadow:0 0 0 1px rgba(16,185,129,.06),0 16px 48px rgba(0,0,0,.5),0 0 24px rgba(16,185,129,.15);box-sizing:border-box}.blindai-title{font-weight:700;font-size:15px;color:#e6eaf0;margin:0 0 6px}.blindai-body{font-size:13px;color:rgba(201,208,219,.78);margin:0 0 14px}.blindai-actions{display:flex;flex-wrap:wrap;gap:8px}.blindai-btn{display:inline-flex;align-items:center;justify-content:center;padding:8px 14px;border-radius:4px;font-family:inherit;font-size:11px;font-weight:600;letter-spacing:.05em;text-transform:uppercase;border:1px solid transparent;cursor:pointer;transition:all .15s ease;line-height:1}.blindai-btn-primary{background:#10b981;color:#06080a}.blindai-btn-primary:hover{background:#34d399;box-shadow:0 0 16px rgba(16,185,129,.4)}.blindai-btn-outline{background:transparent;border-color:rgba(16,185,129,.4);color:#B6FFCB}.blindai-btn-outline:hover{background:rgba(16,185,129,.08);color:#e6eaf0;border-color:rgba(16,185,129,.6)}.blindai-btn-ghost{background:transparent;color:rgba(201,208,219,.6)}.blindai-btn-ghost:hover{background:rgba(16,185,129,.06);color:#B6FFCB}.blindai-badge-row{margin-top:12px;padding-top:10px;border-top:1px solid rgba(16,185,129,.12);display:flex;justify-content:flex-end}.blindai-badge{font-size:10px;color:rgba(201,208,219,.45);text-decoration:none;text-transform:uppercase;letter-spacing:.08em;transition:color .15s ease}.blindai-badge:hover{color:#10b981}.blindai-rows{display:flex;flex-direction:column;gap:8px;margin-bottom:14px;max-height:320px;overflow-y:auto}.blindai-row{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:10px 12px;border:1px solid rgba(16,185,129,.12);border-radius:4px;cursor:pointer;transition:all .15s ease}.blindai-row:hover{border-color:rgba(16,185,129,.3);background:rgba(16,185,129,.03)}.blindai-row-info{flex:1;min-width:0}.blindai-row-name{font-weight:600;font-size:12px;color:#e6eaf0;margin-bottom:2px}.blindai-row-desc{font-size:11px;color:rgba(201,208,219,.55)}.blindai-toggle input[type=checkbox]{width:18px;height:18px;accent-color:#10b981;cursor:pointer;margin:0}.blindai-toggle input[type=checkbox]:disabled{cursor:not-allowed;opacity:.5}@media (max-width:480px){.blindai-card{padding:14px 16px}.blindai-btn{flex:1 1 calc(50% - 4px)}}@media (prefers-reduced-motion:reduce){#blindai-banner{transition:none}}';
