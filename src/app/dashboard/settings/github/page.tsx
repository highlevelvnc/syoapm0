...
export default async function GithubSettingsPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <h1 className="text-3xl font-bold text-matrix-50 mb-2">github dependabot</h1>
      ...
      <div className="terminal-card p-5 mt-8 text-xs text-matrix-200/70 space-y-3">
        ...
        <ol className="space-y-2 list-decimal list-inside">
          ...
          <li>
            <strong className="text-matrix-50">Fine-grained:</strong> escolhe os repos (ou All) →
            permissions:
          ...
          <li>
            <strong className="text-matrix-50">Classic:</strong> scopes:
