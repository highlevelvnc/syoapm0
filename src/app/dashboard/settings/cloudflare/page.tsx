...
export default async function CloudflareSettingsPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <h1 className="text-3xl font-bold text-ink-50 mb-2">cloudflare</h1>
      ...
      <div className="terminal-card p-5 mt-8 text-xs text-ink-300/70 space-y-3">
        ...
        <ol className="space-y-2 list-decimal list-inside">
          ...
          <li>
            Click <strong className="text-ink-50">Create Token</strong> → escolhe o template{" "}
            <strong className="text-ink-50">Edit zone DNS</strong> ou cria custom com permissions:
          ...
          <li>Define <strong className="text-ink-50">Zone Resources</strong> como &quot;All zones&quot; (ou só os domínios específicos).</li>
          <li>Cria, copia o token e cola acima.</li>
        </ol>
        <p className="text-ink-500 pt-2 border-t border-ink-700">
